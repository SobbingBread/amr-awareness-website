...
export const en: Content = {
  ...
  challenge: {
    ...
    stats: [
      { value: "1.27M", label: "deaths / year" },
      { value: "10M", label: "projected by 2050" },
      { value: "73%", label: "from agriculture" },
      { value: "28M", label: "at risk on the Citarum" },
    ],
    ...
    noResultsHint: "Try a different word, category, or difficulty.",
    ...
    simulatorNext: "Next question",
    simulatorClose: "Close",
