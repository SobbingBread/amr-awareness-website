...
export const id: Content = {
  ...
  challenge: {
    ...
    stats: [
      { value: "1,27 Jt", label: "kematian / tahun" },
      { value: "10 Jt", label: "proyeksi pada 2050" },
      { value: "73%", label: "dari pertanian" },
      { value: "28 Jt", label: "berisiko di Citarum" },
    ],
    ...
    tldrLabel: "Singkatnya",
    takeawayLabel: "Inti penting",
    noResultsTitle: "Tidak ada pertanyaan yang cocok",
    noResultsHint: "Coba kata, kategori, atau tingkat kesulitan lain.",
    ...
    simulatorNext: "Pertanyaan berikutnya",
    simulatorClose: "Tutup",
